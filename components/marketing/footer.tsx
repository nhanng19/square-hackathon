...
export default function Footer() {
  const navigation = ["Benefits", "Demo", "Testimonial", "FAQ"];
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-gray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              ...
              live selling, delivering 8X more engagement than
              traditional digital catalog-based selling.
            </div>
          </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          ...
          <a href="https://github.com/nhanng19" target="_blank" rel="noopener">
            Nhan Nguyen.
          </a>{" "}
          Illustrations from{" "}
